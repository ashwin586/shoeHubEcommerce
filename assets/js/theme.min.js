...
var listjs = {
    init: function () {
      var t = $(".list-checkbox-all"),
        e = $(".list-checkbox"),
        a = $(".list-alert"),
        r = $(".list-alert-count"),
        n = $(".list-alert-close");
      function o(t) {
        r.text(e.filter(":checked").length),
          t
            ? a.addClass("show").css("z-index", "1035")
            : a.removeClass("show").css("z-index", "-1");
      }
      t.click(function () {
        this.checked
          ? (e.prop("checked", !0), o(!0))
          : (e.prop("checked", !1), o(!1));
      }),
        e.click(function () {
  ...
  navbar = {
    ...
    initDropdownHover: function () {
      $(".navbar .dropdown").each(function (t, e) {
        ...
        a.hover(
          function () {
            a.find("> [data-bs-toggle='dropdown']").attr("aria-expanded", !0),
              a
                .find("> .dropdown-menu")
                .addClass("show")
          ...
          function () {
            a.find("> [data-bs-toggle='dropdown']").attr("aria-expanded", !1),
              a
                .find("> .dropdown-menu")
                .removeClass("show")
    ...
    toggleSidebar: function () {
      var t = $('[data-toggle="sidebar"]'),
        e = $(".navbar-vertical:not(.navbar-vertical-sm)"),
        a = $(".navbar-vertical.navbar-vertical-sm");
      t.click(function (t) {
        t.preventDefault(),
          "lg" == $(this).data("sidebar")
            ? (e.hide(), a.show())
            : (e.show(), a.hide());
      });
    },
  ...
  charts = {
    ...
    defaults: function () {
      (Chart.defaults.responsive = !0),
        ...
        (Chart.defaults.plugins.tooltip.enabled = !1),
        (Chart.defaults.plugins.tooltip.mode = "index"),
        (Chart.defaults.plugins.tooltip.intersect = !1),
        ...
        (Chart.defaults.scales.linear.ticks.beginAtZero = !0),
        ...
        (Chart.overrides.doughnut.plugins.tooltip.callbacks.title = function (
          t
        ) {
          return t[0].label;
        }),
        (Chart.overrides.doughnut.plugins.tooltip.callbacks.label = function (
          t
        ) {
          var e = t.chart.options.plugins.tooltip.callbacks,
            a = e.beforeLabel() || "",
            r = e.afterLabel() || "";
    ...
    legends: function () {
      ...
      t.forEach(function (t) {
        ...
        null === (e = a.legend.legendItems) ||
          void 0 === e ||
          e.forEach(function (t) {
            r.innerHTML +=
              '<span class="chart-legend-item"><span class="chart-legend-color" style="background-color: '
                .concat(t.fillStyle, '"></span>')
                .concat(t.text, "</span>");
          }),
    ...
    // charts: function () {
    //   var t = document.getElementById("earningsChart"),
    //     e = document.getElementById("expensesChart"),
    //     a = document.getElementById("sourceChart"),
    //     r = document.getElementById("ecommerceChart");
    //   t &&
    //     new Chart(t, {
    //       type: "line",
    //       options: {
    ...
    label: function (t) {
      ...
      return (
        (t.chart.tooltip.dataPoints.length > 1
          ? " " + t.dataset.label + " "
          : " ") + e.options.ticks.callback.apply(e, [t.parsed.y, 0, []])
      );
    },
    tooltip: function (t) {
      var e = t.chart,
        ...
        r = (function (t) {
          ...
          if (!e) {
            ...
            a.classList.add("popover-arrow", "translate-middle-x"),
              r.classList.add("popover-container"),
              e.appendChild(a),
              e.appendChild(r),
              t.canvas.parentNode.appendChild(e);
          }
          return e;
        })(e);
      ...
      if (a.body) {
        ...
        n.forEach(function (t) {
          ...
          o.forEach(function (t, r) {
            var n = a.labelColors[r],
              o = document.createElement("span"),
              l = document.createElement("div");
            o.classList.add("popover-body-color"),
              (o.style.backgroundColor =
                "line" === e.config.type && "rgba(0,0,0,0.1)" !== n.borderColor
                  ? n.borderColor
                  : n.backgroundColor),
              l.classList.add(
                "popover-body",
              ...
              l.classList.add(
                l.length > 1 ? "justify-content-left" : "justify-content-center"
              );
            var s = document.createTextNode(t);
            l.appendChild(o), l.appendChild(s), i.appendChild(l);
          });
        for (var s = r.querySelector(".popover-container"); s.firstChild; )
          s.firstChild.remove();
      ...
      (r.style.visibility = "visible"),
        (r.style.left = c + a.caretX + "px"),
        (r.style.top = u + a.caretY + "px"),
        (r.style.transform =
